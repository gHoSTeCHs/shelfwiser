...
import { ArrowLeft, Box, Package, Plus, Save, Trash2 } from 'lucide-react';
...
export default function Edit({ template, productTypes, categories }: Props) {
    ...
    const [productTypeId, setProductTypeId] = useState(
        template.product_type_id.toString(),
    );
    ...
    const removePackagingType = (variantIndex: number, pkgIndex: number) => {
        ...
        newVariants[variantIndex].packaging_types = newVariants[
            variantIndex
        ].packaging_types.filter((_, i) => i !== pkgIndex);
        setVariants(newVariants);
    };
    ...
    return (
        <>
            ...
            <div className="space-y-6">
                ...
                <Form
                    action={AdminProductTemplateController.update.url({
                        ...
                        <div className="grid gap-6 lg:grid-cols-3">
                                                                        ...
                                                                        onClick={() => {
                                                                            const keyInput =
                                                                                document.getElementById(
                                                                                    `attr-key-${variantIndex}`,
                                                                                ) as HTMLInputElement;
                                                                            const valueInput =
                                                                                document.getElementById(
                                                                                    `attr-value-${variantIndex}`,
                                                                                ) as HTMLInputElement;
                                                                            addVariantAttribute(
                                                                                variantIndex,
                                                                                keyInput.value,
                                                                ...
                                                                {variant.packaging_types.map(
                                                                    (
                                                                        ...
                                                                        <div
                                                                            ...
                                                                            className="flex items-start gap-2 rounded bg-gray-50 p-3 dark:bg-gray-800"
                                                                        >
                                                                            <Box className="mt-2 h-4 w-4 text-gray-400" />
                            ...
                            <div className="space-y-6">
                                ...
                                <div className="flex justify-end gap-3">
                                    <Link
                                        href={AdminProductTemplateController.index.url()}
                                    >
