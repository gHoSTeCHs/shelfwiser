...
import { Plus, X, DollarSign, Save, ArrowLeft } from 'lucide-react';
...
export default function Create({ products }: Props) {
    ...
    const [visibility, setVisibility] = useState<CatalogVisibility>('connections_only');
    ...
    return (
        <>
            ...
            <div className="space-y-6">
                ...
                <Form action={route('supplier.catalog.store')} method="post" className="space-y-6">
                    {({ errors, processing }) => (
                        <>
                            <Card className="p-6">
                            ...
                            <div className="flex justify-end gap-3">
                                ...
                                <Button type="submit" disabled={processing}>
                                    ...
                                    {processing ? 'Adding...' : 'Add to Catalog'}
                                </Button>
                            </div>
                        </>
                    )}
