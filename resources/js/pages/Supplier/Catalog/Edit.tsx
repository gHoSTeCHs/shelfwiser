...
export default function Edit({ catalogItem }: Props) {
    ...
    const { data, setData, put, processing, errors } = useForm({
        is_available: catalogItem.is_available,
        base_wholesale_price: catalogItem.base_wholesale_price.toString(),
        min_order_quantity: catalogItem.min_order_quantity.toString(),
        visibility: catalogItem.visibility,
        description: catalogItem.description || '',
        pricing_tiers: catalogItem.pricing_tiers || [],
    });

    const handleSubmit: FormEventHandler = (e) => {
        e.preventDefault();
        put(route('supplier.catalog.update', catalogItem.id));
    };
                        ...
                        <div className="space-y-4">
                            <div>
                                ...
                                <Input
                                    ...
                                    onChange={(e) =>
                                        setData('base_wholesale_price', e.target.value)
                                    }
                            ...
                            <div>
                                ...
                                <Select
                                    ...
                                    onChange={(value) =>
                                        setData('visibility', value as CatalogVisibility)
                                    }
                                />
                            </div>
                    ...
                    <Card className="p-6">
                        ...
                        {pricingTiers.length > 0 ? (
                            ...
                            <p className="text-center text-sm text-gray-500 dark:text-gray-400">
                                No volume pricing tiers defined. Buyers will pay the base wholesale
                                price.
                            </p>
                        )}
                    </Card>
