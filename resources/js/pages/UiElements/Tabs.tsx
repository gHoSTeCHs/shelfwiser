            ...
            <div className="grid grid-cols-1 gap-5 sm:gap-6">
                    ...
                    <Tab>
                        ...
                        <TabContent>
                            <p className="text-sm text-gray-600 dark:text-gray-400">
                                ...
                                {activeTab === 'analytics' &&
                                    'Analytics ipsum dolor sit amet consectetur. Non vitae facilisis urna tortor placerat egestas donec.'}
                                {activeTab === 'customers' &&
                    ...
                    <Tab>
                        <TabList variant="underline">
                            <TabTrigger
                                ...
                                onClick={() =>
                                    setActiveUnderlineTab('overview')
                                }
                            >
                                Overview
                            </TabTrigger>
                            <TabTrigger
                                ...
                                onClick={() =>
                                    setActiveUnderlineTab('notification')
                                }
                            >
                                Notification
                            </TabTrigger>
                            <TabTrigger
                                ...
                                onClick={() =>
                                    setActiveUnderlineTab('analytics')
                                }
                            >
                                Analytics
                            </TabTrigger>
                            <TabTrigger
                                ...
                                onClick={() =>
                                    setActiveUnderlineTab('customers')
                                }
                            >
                                Customers
                            </TabTrigger>
                        ...
                        <TabContent>
                            <p className="text-sm text-gray-600 dark:text-gray-400">
                                Overview ipsum dolor sit amet consectetur. Non
                                vitae facilisis urna tortor placerat egestas
                                donec. Faucibus diam gravida enim elit lacus a.
                            </p>
                        </TabContent>
                    </Tab>
                </ComponentCard>
                ...
                <ComponentCard title="Tab with line and icon">
                    <Tab>
                        ...
                        <TabContent>
                            <p className="text-sm text-gray-600 dark:text-gray-400">
                                Notification ipsum dolor sit amet consectetur.
                                Non vitae facilisis urna tortor placerat egestas
                                donec.
                            </p>
                        </TabContent>
                    </Tab>
                    ...
                    <Tab>
                        <TabList variant="badge">
                            ...
                            <TabTrigger
                                ...
                                onClick={() =>
                                    setActiveBadgeTab('notification')
                                }
                            >
                                Notification
                            </TabTrigger>
