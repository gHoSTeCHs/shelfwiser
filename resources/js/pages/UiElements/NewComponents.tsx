          ...
          <div className="space-y-6">
            <div>
              ...
              <div className="grid grid-cols-1 gap-6 md:grid-cols-2 lg:grid-cols-3">
                <div className="space-y-4">
                  <h5 className="font-medium text-gray-700 dark:text-gray-300">Simple Toggle</h5>
                  <Toggle
                ...
                <div className="space-y-4">
                  <h5 className="font-medium text-gray-700 dark:text-gray-300">With Label</h5>
                  <Toggle
                ...
                <div className="space-y-4">
                  <h5 className="font-medium text-gray-700 dark:text-gray-300">Disabled</h5>
                  <Toggle
            ...
            <div>
              ...
              <div className="flex items-center gap-8">
                ...
                <div className="space-y-2">
                  <p className="text-sm text-gray-600 dark:text-gray-400">Medium (Default)</p>
                  <Toggle
                    size="md"
                    checked={toggleStates.simple}
                    onChange={handleToggleChange("simple")}
            ...
            <div>
              ...
              <div className="flex items-center gap-4">
                <Tooltip content="User profile information">
                  <UserIcon className="w-6 h-6 text-gray-600 dark:text-gray-400 cursor-pointer hover:text-gray-800 dark:hover:text-gray-200" />
                </Tooltip>
                
                <Tooltip content="Send an email" delay={100}>
                  <MailIcon className="w-6 h-6 text-gray-600 dark:text-gray-400 cursor-pointer hover:text-gray-800 dark:hover:text-gray-200" />
                </Tooltip>
              </div>
            </div>
          </div>
            ...
            <div>
              ...
              <div className="flex items-center gap-4">
                <Popover
                  ...
                  position="right"
                >
                  <span className="px-3 py-2 text-sm bg-gray-100 rounded-lg cursor-pointer dark:bg-gray-700 dark:text-gray-300">
                    Hover me
                  </span>
                </Popover>
              </div>
