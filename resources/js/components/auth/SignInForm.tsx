            ...
            <div className="mx-auto flex w-full max-w-md flex-1 flex-col justify-center py-8">
                ...
                >
                    ...
                    <div className="grid grid-cols-2 gap-3">
                        <button className="inline-flex items-center justify-center gap-2 rounded-xl border border-gray-200 bg-white px-4 py-2.5 text-sm font-medium text-gray-700 transition-colors hover:bg-gray-50 dark:border-navy-700 dark:bg-navy-800 dark:text-gray-300 dark:hover:bg-navy-700">
                            <svg
                                className="h-5 w-5"
                                viewBox="0 0 20 20"
                                fill="none"
                    ...
                    <div className="relative my-6">
                        ...
                        <div className="relative flex justify-center">
                            <span className="bg-white px-4 text-sm text-gray-500 dark:bg-navy-900 dark:text-gray-400">
                            ...
                            <>
                                ...
                                <div className="flex items-center justify-between">
                                    <div className="flex items-center gap-2">
                                        ...
                                        <Label
                                            htmlFor="remember"
                                            className="mb-0 text-sm font-normal text-gray-600 dark:text-gray-400"
                                        >
                                            Remember me
                                        </Label>
                                    </div>
